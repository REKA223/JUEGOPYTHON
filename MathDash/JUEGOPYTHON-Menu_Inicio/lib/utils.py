"""Utilidades de apoyo para el juego.

Contiene funciones auxiliares para cargar/transformar imágenes, dibujar
elementos de HUD y helpers varios que no pertenecen a una clase en particular.
"""
